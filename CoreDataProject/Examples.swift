...
struct DynamicFetchRequest: View {
    ...
    var body: some View {
        VStack {
            FilteredList(sortDescriptors: [], filterKey: "lastName", predicate: "BEGINSWITH", filterValue: lastNameFilter) { (singer: Singer) in
